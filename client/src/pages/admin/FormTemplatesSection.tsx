...
export function FormTemplatesSection() {
  ...
  return (
    <div className="card">
      ...
      <DataTable tableId="admin.formTemplates" exportModule="admin" columns={columns} data={templates ?? []} isLoading={isLoading} clientPageSize={8} emptyMessage="No form templates yet." />
