    ...
    <div>
      ...
      {data && data.total > 0 && (
        <div className="card" style={{ marginTop: 16 }}>
          ...
          <DataTable tableId="operational.showAssets" exportModule="operational-context" columns={showAssetColumns} data={data.assets} clientPageSize={10} emptyMessage="No show assets." />
        </div>
      )}
    </div>
  );
